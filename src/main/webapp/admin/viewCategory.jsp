<%@page import="com.vegetable.CategoryDAO"%>
<%@page import="com.vegetable.Category"%>
...
<body>
	...
	<div class="bg-white vertical-nav" id="sidebar">
		...
		<div class="bg-light py-4 px-3 mb-1">
			<p class="font-weight-bold text-uppercase px-3 sidebar-title text-center"><span style="color:green">Online Vegetable</span> <span style="color:red">Shop</span></p>
